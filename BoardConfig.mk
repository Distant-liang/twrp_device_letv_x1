...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/letv/x1/dt.img
...
# Recovery
TARGET_RECOVERY_FSTAB := device/letv/x1/recovery/etc/fstab.qcom
...
TARGET_RECOVERY_INITRC := device/letv/x1/recovery/etc/init.rc
...
TW_CUSTOM_THEME :=device/letv/x1/recovery/twres
